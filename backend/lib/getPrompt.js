export const getPrompt = (tableSchema, tableName) => {
  const configFields = {
    baseTableName: {
      type: 'String',
      required: true,
      description: 'Name of the base table used to create report',
    },
    title: {
      type: 'String',
      required: true,
    ...
    reportType: {
      type: 'String',
      required: true,
      allowedValues: ['chart', 'pivot', 'summary'],
    },
    chartType: {
      type: 'String',
    ...
    mergeAxisInfo: {
      type: 'String',
      requiredIf: 'isAxisMerge == true',
      formatExample: {
        axisIndex: [2, 3],
        labelName: 'Merge_axis',
      },
    },
  };
